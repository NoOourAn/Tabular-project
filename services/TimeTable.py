...
class Data:
    ...
    def __init__(self):
        print("dataaaaaa")
        data = ma3lomat.fetch_data()
        print("adadadaddada")
        self.ROOMS = data.fetch_rooms_data()
        self.cat = data.fetch_students_data()    # course:course-info (name-ins-....)
        self.co =data.fetch_subjects_data()    # course:students
        self.d = data.fetch_dept_data()
        self.Time_Avilable = data.fetch_time_data()
        self._rooms = []
        self._TimeAvilable = []
        self._instructors = []
        self._students = []
